...
{#if !isDev}
  <div style="padding: 2rem; font-family: system-ui, sans-serif; text-align: center;">
    <h2>404 — Not Found</h2>
    <p>The developer workbench is disabled in production mode.</p>
    <a href="/">← Return to FormaTavern</a>
  </div>
{:else}
  <div style="padding: 1rem; font-family: system-ui, sans-serif; max-width: 1000px; margin: 0 auto;">
