...
<dialog
  ...
  class="fixed inset-y-0 left-0 m-0 flex h-full w-full max-w-sm flex-col border-r border-neutral-800 bg-neutral-900/98 p-0 text-neutral-100 shadow-2xl backdrop:bg-black/70 backdrop:backdrop-blur-sm max-sm:bottom-0 max-sm:top-auto max-sm:h-[80vh] max-sm:max-w-none max-sm:rounded-t-2xl max-sm:border-r-0 max-sm:border-t"
